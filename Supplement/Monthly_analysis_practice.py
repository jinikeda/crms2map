...
Processspace = os.path.join(Workspace, 'Process')
...
# MA_datasets["WL"].to_excel(os.path.join(Processspace, 'MA_timeseris_WL.xlsx'))  # Save the moving average dataset for analyzing a spatial mapping paper
...
MA_datasets_discrete["Pore_10"].to_csv(os.path.join(Processspace,'Pore_10_MA.csv'))
datasets_discrete["Pore_10"].to_csv(os.path.join(Processspace,'Pore_10.csv'))
...
print(df_MA_temp)
df_MA_temp.to_excel(os.path.join(Processspace,'MA_timeseris.xlsx'))
...
df_MA_temp.to_excel(os.path.join(Processspace,output_name))
...
SST.head()
SST.to_excel(os.path.join(Processspace,'monthly_median_for_correlation.xlsx'))
#
...
HP_stats.to_csv(os.path.join(Processspace,'HP_interval10.csv'))
