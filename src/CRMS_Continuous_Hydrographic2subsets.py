...
from src.CRMS_general_functions import download_CRMS


start_time = time.time()

# The target working directory
Workspace = os.path.abspath(os.path.join(os.getcwd(), os.pardir))  # Move up to the parent directory
...
CRMS_continuous.index = CRMS_continuous.index.floor('T')
