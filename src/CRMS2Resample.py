...
for Data in Data_list:
    ...
    if (Data == 2 or Data == 3):
        ...
        CRMS_subset_SLR = CRMS_subset.add (0.3) # SLR in 2050 Sweet 2022
    ...
    if (Data==3):
        ...
        file_name4 = file_name + '_SLR2050'
        file_name5 = file_name + '_wdepth_SLR2050'
        file_name6 = file_name + '_wd_SLR2050'
        file_name_list.extend([file_name2, file_name3,file_name4,file_name5,file_name6])
        file_name_list
    ...
    for i in range(len(datasets)):
        ...
        yearly_mean = monthly_mean.resample('AS').mean().where(monthly_mean.resample('AS').count() >= 9)               # Use only include more than 9 months average data
